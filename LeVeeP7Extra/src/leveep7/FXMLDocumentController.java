...
// LeVeeE4, FXMLDocumentController.java
...
public class FXMLDocumentController implements Initializable
{
    ...
    @FXML private RadioButton rButtre;
    @FXML private RadioButton rButtqe;
    
    
    Enigma messages [] = new Enigma [4];
    PrimeShiftEnigma pse = new PrimeShiftEnigma();
    ShiftyEnigma se = new ShiftyEnigma();
    ReversedEnigma re = new ReversedEnigma();
    QwertyEnigma qe = new QwertyEnigma();
    boolean generate;
    String message;
    String codedMess;
    String result;
    ...
    @FXML private void handleRButtreAction(ActionEvent event)
    {
        eType = 2;
    }
    
    @FXML private void handleRButtqeAction(ActionEvent event)
    {
        eType = 3;
    }
    ...
    @FXML private void handleMiOpenAction(ActionEvent event) 
    {
        ...
        if (file != null) 
        {
            try
            {
                ...
                messages[eType].setCodedMessage(codedMess, parseInt(in.readLine()));
                in.close();
                ...
                switch (eType)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        rButtre.setSelected(true);
                        break;
                    case 3:
                        rButtqe.setSelected(true);
                }
            }
            catch (Exception e)
            {
    ...
    {
        tAreaInfo.setText("Welcome to Program 7 by Angela LeVee with extra encoding options.");
    }
